...
def main():
    ...
    print("rendimientos:",rendimientos_aplicacion)
    ...
    #graficamos la evolucion de los rendimientos
    x_re=list(fechas_aplicacion[1:])
    ...
    for fecha in range(len(x)):
        ...
        y_re[fecha]=rendimientos_aplicacion[0][fecha]

        z_re[fecha]=rendimientos_aplicacion[1][fecha]

        k_re[fecha]=rendimientos_aplicacion[2][fecha] 
        

    plt.plot(x_re,y_re,"r-o")

    plt.plot(x_re,z_re,"b-o")

    plt.plot(x_re,k_re,"g-o")

    plt.legend(["rendimiento_MERCADO_LIBRE","rendimiento_ZOOM","rendimiento_AMERICAN_AIRLINES"])
